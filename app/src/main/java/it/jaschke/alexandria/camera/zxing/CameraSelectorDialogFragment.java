package it.jaschke.alexandria.camera.zxing;
...
public class CameraSelectorDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(R.string.select_camera)
                ...
                .setPositiveButton(R.string.zxing_ok_button, new DialogInterface.OnClickListener() {
                    @Override
                ...
                .setNegativeButton(R.string.zxing_cancel_button, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int id) {
                    }
                });
